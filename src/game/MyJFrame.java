...
public class MyJFrame extends JFrame implements Runnable {
    ...
    private static final float ratioWH = 750f / 900f;
	...
	super.pack();
	super.setSize((int) (Toolkit.getDefaultToolkit().getScreenSize().getHeight() * ratioWH), (int) (Toolkit.getDefaultToolkit().getScreenSize().getHeight()));
